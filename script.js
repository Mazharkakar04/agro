...
let isLoading = false;
    ...
    async function handleUpdateProduct(event) {
      ...
      try {
        ...
        // Reset form and change back to add product mode
        resetProductForm();
